...
- Lecture 4 - More About Finite Fields (Field Characteristic, Algebraic Structure of Finite Fields and Irreducible Polynomials)
- Lecture 5 - Finite Fields, Algorithms (Uniqueness of Finite Fields, Modular Exponentiation and Pseudo-Primes)
...
- Lecture 10 - The Magic of Probability (Introduction to using Probability Algorithms with One-sided Error for Testing)
...
- Lecture 15 - Distributed Algorithms - Leader Election II (Time Slice Algorithm and Lower Bound for the Leader Election Algorithm)
