...
\textbf{gcd}$(p, q) = (x - 5)$
\end{center}
By Bézout's identity for polynomials, there exist polynomials $u$ and $v$ such that:
\begin{center}
$(x - 5) = u \cdot p(x) + v \cdot q(x)$
\end{center}
where $u = \frac{1}{24}(5x - 34)$ and $v = -\frac{1}{24}(5x - 9)$ are the polynomials in $\mathbb{Q}[x]$ satisfying this identity.
\end{proof}
\end{document}
